...
function change (ele){
    ...
    if ( image_tracker == 'l'){
         ...
         image.src='./image/like-bleu.jpg';
        image_tracker= 'b';
    }else{
        image.src='./image/like.jpg';
        image_tracker = 'l';
    }
...
function addItemToCart(title, price, imageSrc) {
    ...
    var bleulike= `<img src ="./image/like.jpg" alt ="like bleu" id="like-bleu"  onclick="change(this)">`
    cartRow.innerHTML = cartRowContents + bleulike
